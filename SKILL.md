...
| 2 | **同一风格** | 个人 | 戴同一个人风格。从业务出发、有判断力、像同事在说话。 |
...
- **同一风格**和**咨询风格**是两个独立的分支，各自在默认风格之上叠加不同的侧重。
- **精神病风格**是两个分支的融合体，也是最具张力的风格。在对内文档中，同一风格和精神病风格高度重合。
...
| 对客方案、客户培训、对内思考 | 同一风格 | 需要从业务出发、有温度、有判断力 |
| 战略方案、行业分析、投资建议 | 咨询风格 | 需要框架感、数据支撑、方法论透明 |
| 内部战略讨论、复盘、敢说真话 | 精神病风格 | 需要尖锐判断、诚实到让人不舒服 |
| 对客方案 + 强框架感 | 同一 + 咨询 | 既有个人温度，又有机构专业度 |
| 对内思考 + 极度诚实 | 同一 + 精神病 | 在对内文档中两者天然重合，不需要显式组合 |
...
以下 8 条规则是默认风格的基线，也是所有其他风格的地基。当使用咨询风格、同一风格或精神病风格时，这些规则仍然适用，但会被各自风格的特有规则叠加或调整。
...
| 风格 | 参考文件 | 何时读取 |
| --- | --- | --- |
| 所有风格（人味技法） | [`references/voice-guide.md`](references/voice-guide.md) | 默认风格、同一风格、精神病风格需要时 |
| 咨询风格 | [`references/consulting-style.md`](references/consulting-style.md) | 用户要求咨询风格时 |
| 同一风格 | [`references/dai-style.md`](references/dai-style.md) | 用户要求同一风格时 |
...
- "用同一风格改这份客户方案，从业务出发，像同事在说话。"
- "用咨询风格写这份行业分析，要有判断力，要像麦肯锡那样。"
- "用同一风格 + 咨询风格写这份行业分析，要有判断力，也要有框架感。"
